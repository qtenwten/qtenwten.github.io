...
async function run() {
  ...
  const t = makeT({
    'addressee.scenarioUx.options.application.label': 'Russian application',
    'addressee.scenarioUx.options.application.description': 'Application desc',
    'addressee.scenarioUx.options.application.hint': 'Application hint',
    'addressee.scenarioUx.options.applicationDirector.label': 'Application to director',
    'addressee.scenarioUx.options.applicationDirector.description': 'Director desc',
    'addressee.scenarioUx.options.applicationDirector.hint': 'Director hint',
    'addressee.scenarioUx.options.memo.label': 'Russian memo',
    'addressee.scenarioUx.options.memo.description': 'Memo desc',
    'addressee.scenarioUx.options.memo.hint': 'Memo hint',
    'addressee.scenarioUx.options.complaint.label': 'Russian complaint',
    'addressee.scenarioUx.options.complaint.description': 'Complaint desc',
    'addressee.scenarioUx.options.complaint.hint': 'Complaint hint',
    'addressee.scenarioUx.options.request.label': 'Russian request',
    'addressee.scenarioUx.options.request.description': 'Request desc',
    'addressee.scenarioUx.options.request.hint': 'Request hint',
    'addressee.scenarioUx.options.businessLetter.label': 'Business-style Russian letter',
    'addressee.scenarioUx.options.businessLetter.description': 'Business desc',
    'addressee.scenarioUx.options.businessLetter.hint': 'Business hint',
    'addressee.scenarioUx.options.custom.label': 'Custom Russian document',
    'addressee.scenarioUx.options.custom.description': 'Custom desc',
    'addressee.scenarioUx.options.custom.hint': 'Custom hint',
    'addressee.scenarioUx.options.csvBulk.label': 'CSV / multiple addressees',
    'addressee.scenarioUx.options.csvBulk.description': 'CSV desc',
    'addressee.scenarioUx.options.csvBulk.hint': 'CSV hint',
  });
