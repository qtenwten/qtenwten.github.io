...
function TimeCalculator() {
  ...
  return (
    <>
      <SEO
        title="Калькулятор времени онлайн - Сложение и вычитание времени"
        description="Онлайн калькулятор времени. Сложение, вычитание и расчет разницы времени. Формат ЧЧ:ММ или ЧЧ:ММ:СС."
