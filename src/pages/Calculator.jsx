...
function Calculator() {
  ...
  return (
    <>
      <SEO
        title="Калькулятор онлайн с процентами - Расчет процентов от числа"
        description="Онлайн калькулятор с процентами и историей. Рассчитать процент от числа, сложение, вычитание, умножение. Быстрые вычисления."
        path="/calculator"
        keywords="калькулятор онлайн, калькулятор с процентами, расчет процентов, онлайн калькулятор бесплатно"
      />
