...
function RandomNumber() {
  ...
  return (
    <>
      <SEO
        title="Генератор случайных чисел онлайн - Рандомайзер"
        description="Бесплатный генератор случайных чисел. Выберите диапазон, количество и получите уникальные или повторяющиеся числа. Быстро и удобно."
        path="/random-number"
      />
