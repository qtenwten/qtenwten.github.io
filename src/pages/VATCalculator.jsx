...
function VATCalculator() {
  ...
  return (
    <>
      <SEO
        title="Калькулятор НДС онлайн - Расчет налога на добавленную стоимость"
        description="Бесплатный онлайн калькулятор НДС. Добавить, убрать или рассчитать НДС. Поддержка разных ставок: 5%, 10%, 18%, 20%, 22%."
        path="/vat-calculator"
      />
