...
export const ROUTE_REGISTRY = [
  ...
  {
    key: 'addresseeGenerator',
    path: '/generator-adresata',
    componentKey: 'AddresseeGenerator',
    titleKey: 'tools.addresseeGenerator.title',
    descriptionKey: 'tools.addresseeGenerator.description',
    categoryKey: 'categories.generators',
    categorySlug: 'generators',
    icon: 'person',
    showOnHome: true,
...
export const LEGACY_ROUTE_REDIRECTS = {
  ...
  '/generator-adresata': '/ru/generator-adresata/',
