export const ROUTE_SEO = {
  '/': {
    ru: {
      ...
      h1: 'QSEN — быстрые сервисы для расчётов, ссылок, текста и SEO',
    ...
    en: {
      ...
      h1: 'QSEN — fast online services for calculations, links, text, and SEO',
      image: 'https://qsen.ru/og-image.png',
    },
  },
  '/search': {
    ru: {
      title: 'Поиск по инструментам | QSEN.RU',
      description: 'Найдите нужный калькулятор, генератор или SEO-инструмент по названию, описанию и ключевым словам.',
      keywords: 'поиск по инструментам, найти калькулятор, найти генератор, поиск по сайту',
      h1: 'Поиск по инструментам',
      image: 'https://qsen.ru/og-image.png',
      robots: 'noindex,follow',
      includeInSitemap: false,
    },
    en: {
      title: 'Search Tools | QSEN.RU',
      description: 'Search calculators, generators, and SEO tools by title, description, and related keywords.',
      keywords: 'search tools, site search, find calculator, find generator, search utilities',
      h1: 'Search tools',
      image: 'https://qsen.ru/og-image.png',
      robots: 'noindex,follow',
      includeInSitemap: false,
          ...
          },
          {
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Да, DOCX экспорт доступен. Нажмите кнопку «Скачать DOCX» — документ с адресатом, отправителем, обращением и шаблоном сохранится в файл.',
                },
              },
              {
                '@type': 'Question',
...
export function getAllLocalizedSeoPages() {
  return Object.entries(ROUTE_SEO).flatMap(([path, localized]) => (
    ['ru', 'en'].map((language) => ({
      language,
      path,
